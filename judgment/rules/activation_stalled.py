"""A signed-up customer with no first captured lead past STALL_DAYS — the churn cliff,
the single most valuable nudge in the system."""
...
class _Rule:
    name = "activation_stalled"
    priority = 2
    recipient = Recipient.YOUNG
    nudge = "Customer never activated — churn risk, call them"
